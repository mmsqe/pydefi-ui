...
GET  /api/yields/markets          — enumerate Aave V3 + Compound V3 supply markets
...
async def list_markets(
    ...
    """Enumerate active Aave V3 + Compound V3 supply markets for *token_symbol*,
    sorted by APY descending. Chains without a configured RPC are skipped."""
    w3s = get_w3s()
